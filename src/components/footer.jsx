...
function footer() {
  return (
    <>
      {/* <img
          className="absolute z-0 drop-shadow-[0px_0px_20px_black] h-full scale-[1.3] left-[2.5%] rotate-[-20deg] top-[-18%]"
          src={imgofLeft}
          alt="background image to be come here"
        /> */}
      {/* <div className="absolute z-10 grid bottom-[-15%] left-5 w-full text-[0.7rem]"></div> */}
